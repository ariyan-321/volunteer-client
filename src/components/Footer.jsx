    ...
    <div className="mt-[60vh] bg-gradient-to-br from-green-600 to-green-800 text-white  ">
      <footer className=" py-12 container mx-auto px-4">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <aside className="space-y-4">
            ...
            <p className="text-sm leading-relaxed">
              Join hands to make a difference. Volunteer Hub connects passionate
              individuals to meaningful causes and inspires community-driven
              impact.
            </p>
          </aside>
          ...
          <nav>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/all-volunteer-need" className="hover:underline">
          ...
          <nav>
            ...
            <ul className="space-y-3">
              <li>
                Email:{" "}
                <a
                  href="mailto:info@volunteerhub.com"
        ...
        <div className="mt-10 text-center border-t border-green-500 pt-6">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} Volunteer Hub. All rights
            reserved. Built with ❤️ for the community.
          </p>
        </div>
      </footer>
    </div>
