        ...
        <div className="navbar-start flex items-center gap-3 ">
          <div className="dropdown">
            ...
            >
              ...
              <li>
                <Link to="/all-volunteer-need">All Volunteer Need</Link>
              </li>
              <li>
          ...
          <Link to="/" className="logo flex items-center gap-3 cursor-pointer">
            <img
              ...
              alt="logo"
            />
            <h1 className="font-bold text-lg md:text-3xl flex items-center gap-2">
              Volunteer <span className="hidden md:block">Hub</span>
            </h1>
          </Link>
        </div>
